...
The defaults are: both phong model perspective bilinear
"#, cmd_name)
}
...
fn main() {
    ...
    let mut canvas = Canvas::new("Raster 12 plus bilinear filtering (based on chapter 14)", CANVAS_WIDTH, CANVAS_HEIGHT);
